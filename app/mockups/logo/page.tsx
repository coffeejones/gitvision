// Logo mockup gallery — 6 concept directions for CodeTrawl's visual
...
//
// How to use:
//   - Pick the concept that feels closest to CodeTrawl's voice
    ...
    <main className="max-w-6xl mx-auto px-8 pt-12 pb-20 flex flex-col gap-10">
      ...
      <header className="flex flex-col gap-3">
        ...
        <p
          ...
          style={{ color: TOK.textSecondary }}
        >
          Six directions for CodeTrawl&apos;s visual identity. Each shows the
