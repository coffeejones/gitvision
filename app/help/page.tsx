// /help — long-form documentation for CodeTrawl's mental models
...
//   - Marketing copy ("Welcome to CodeTrawl!"). The home page
//     already does that.
...
export const metadata = {
  title: "Help — CodeTrawl",
  description:
    "How the panels, signals, and diagrams in CodeTrawl work — the mental models behind the UI.",
};
...
export default function HelpPage() {
  return (
    // The docs used to render bare — no shell, no nav, no footer, on the
    // retired cool-grey workspace palette — so the one page in the sitemap
    // besides the landing and pricing looked like a different product. It sits
    // on the marketing surface now. The measure stays narrower than .wrap:
    // this is long-form prose, and 1180px of it would be unreadable.
    <CTSurface>
      <CTNav />
      <main className="max-w-3xl w-full mx-auto px-8 pt-14 pb-20 flex flex-col gap-10">
        <header className="flex flex-col gap-3">
          <span className={STYLE.eyebrow} style={{ color: "var(--ct-dim)" }}>
            Help
          </span>
          <h1
          ...
          <p
            ...
            style={{ color: "var(--ct-dim)" }}
          >
            CodeTrawl packs a lot into each tab. This page explains the
        ...
        <Section id="sessions-snapshots" title="Sessions & snapshots">
          ...
          <P>
            ...
            session. Every time you click <strong>Refresh</strong>, CodeTrawl
        ...
        <footer
          ...
          style={{ borderColor: "var(--ct-line)", color: "var(--ct-faint)" }}
        >
          <p>
  ...
  return (
    ...
    >
      <h2
        ...
        style={{ color: "var(--ct-text)", letterSpacing: "-0.01em" }}
      >
        {title}
      </h2>
