...
export const metadata = {
  title: "Privacy & Terms — RepoJury",
  description:
    "What RepoJury stores, what it doesn't, and the terms you accept by using it.",
};
  ...
  return (
    <main className="max-w-2xl w-full mx-auto px-8 pt-16 pb-20 flex flex-col gap-10">
      ...
      <header className="flex flex-col gap-3">
        ...
        >
          What we store, and what you accept by using RepoJury.
        </h1>
        <p
          className="text-base leading-relaxed"
          style={{ color: TOK.textSecondary }}
        >
          RepoJury is in alpha. This page is short on purpose — we want
      ...
      <Section title="Privacy">
        <P>
          <strong>No accounts.</strong> RepoJury has no sign-up, no
      ...
      <Section title="Terms">
        <P>
          <strong>Alpha software, no warranty.</strong> RepoJury is
        ...
        <P>
          <strong>License.</strong> The RepoJury source code is{" "}
          <a
        ...
        <P>
          ...
          anything you actually care about, run RepoJury locally and
      ...
      >
        Last updated: 2026-04-29 · RepoJury is made by{" "}
        <a
