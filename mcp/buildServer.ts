...
export const SERVER_NAME = "repobaron";
export const SERVER_VERSION = "0.67.0";

/** Build a fully-configured RepoBaron MCP server with all tools
...
export function buildServer(): McpServer {
  ...
  server.registerTool(
    ...
    {
      description:
        "Download a GitHub repo, run AST + git-history analysis, return a session id and a compact summary. Always call this first — every other RepoBaron tool needs the session id. Cached for 10 minutes per repo URL so subsequent calls on the same URL are free.",
