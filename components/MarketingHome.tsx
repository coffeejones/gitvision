    ...
    >
      ...
      <main className="max-w-7xl w-full mx-auto px-6 sm:px-10 lg:px-12 pt-10 pb-16 flex flex-col gap-14">
        ...
        <section className="flex flex-col gap-5">
          ...
          >
            ...
            . No prompts, no hallucinations, no LLM bill — just 18
      ...
      <section className="flex flex-col gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            {
              t: "Repo health",
              d: "Red / yellow / green verdict grounded in 18 deterministic signals — complexity, churn, coverage, dependencies. No AI hallucination.",
              icon: Activity,
            },
            {
      ...
      <section id="pr-bot" className="flex flex-col gap-5 scroll-mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <SurfaceCard
            eyebrow="Workspace"
            title="One repo, all 18 signals"
            body="Paste a URL. Get an explorable canvas, blast radius, untested hotspots, near-duplicates, dependency health, and a red / yellow / green verdict grounded in 18 deterministic signals — all under one workspace."
  ...
  return (
    <div className="flex flex-col gap-3 py-1">
      <span
        ...
        style={{ color: TOK.textMuted }}
      >
        18 signals · scored across 6 dimensions
      </span>
