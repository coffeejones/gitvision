      ...
      <div className="flex items-baseline justify-between gap-2 flex-wrap">
        <div className="flex items-baseline gap-2 flex-wrap">
          ...
          <span
            ...
            title="These tiles are computed from 19 deterministic rule-based signals — no AI involved. The /insights page adds Claude's plain-English commentary on the same signals."
          >
